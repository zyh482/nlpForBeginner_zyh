...
best_model_path = '/home/zhangyuhan/NLPcodes/poetryFromTang/best_gru_model.bin'
...
print(f'Best_valid_loss: {best_valid_loss:.4f} | Best_valid_PPL {best_valid_ppl:.2f}')
...
#output = model.generate(txt, vocab)
poetry = generate(model, txt, vocab)
print(poetry) 