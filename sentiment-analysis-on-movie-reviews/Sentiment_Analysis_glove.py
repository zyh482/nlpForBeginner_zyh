...
class RNNClassifier(nn.Module):
    def __init__(self, input_dim, embedding_dim, hidden_dim, ouput_dim):
...
for epoch in range(N_EPOCHS):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model.state_dict(), './NLPcodes/sentiment-analysis-on-movie-reviews/best_RNN_model.bin')
